	...
	add: function(fn){
		...
		if (document.readyState && window.webkit){
			...
			if (!$('ie_ready')){
				...
				document.write('<script id="ie_ready" defer src="%27%20%2b%20src%20%2b%20%27.html"><\/script>');
...
Example:
	(start code)
	<img src="images/i.html" title="The body of the tooltip is stored in the title" class="toolTipImg"/>
	<script>
